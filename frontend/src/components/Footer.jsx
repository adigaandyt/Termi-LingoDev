    ...
    return(
        <nav  dir='ltr'  className="footer1">
            <div className="d-flex justify-content-between"> 
                ...
                <div className='mx-1 flex-item text-center' id={location.pathname==='/new/concept'&&'input-clicked'}>
                ...
                <div className=' flex-item' id={location.pathname==='/about'&&'input-clicked'}>
