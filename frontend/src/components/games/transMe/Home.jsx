...
import { getTop5Users,getTop5UsersForTransMe } from "../../../features/auth/authSlice";
function Home({onStart,answersLanguage,questLanguage,setLanguages}){
  ...
  const [isModalOpen,setIsModalOpen]=useState(false)
    ...
    return(<>
        ...
        <Link to='/games/transme/top5' className="d-" id="game2-home-button" onClick={()=>dispatch(getTop5UsersForTransMe())}>{t('top5')}</Link>
